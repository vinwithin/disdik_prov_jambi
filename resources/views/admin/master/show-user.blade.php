...
<div>
    ...
    <div class="d-flex justify-content-between mb-3">
        <h1 class=" text-dark fs-3">User</h1>
    </div>
   
        <div class="card p-3 shadow">
            <div class="table-responsive col-lg-10">
                <a href="/admin/master/add-user" class="btn btn-primary mb-3">Tambah User</a>
                @if (count($user) > 0)
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/admin/master/edit-user/{{$post->id}}" class="badge bg-warning"><i
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="/admin/master/delete/{{$post->id}}" class="btn btn-primary">Iya</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
