...
@section('content')
    ...
    <div class="card p-4">
        ...
        <form action="/admin/foto/edit-foto/{{$foto->slug}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="title" class="form-label">Judul</label>
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{$foto->title}}"  required
                    >
                @error('title')
            ...
            <div class="input-group mb-3">
                <input type="file" class="form-control @error('foto') is-invalid @enderror" id="foto"
                      name='foto' accept="image/png, image/jpeg, image/jpg" required>
