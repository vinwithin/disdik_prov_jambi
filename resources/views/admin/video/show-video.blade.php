...
<div>
    ...
    <div class="d-flex justify-content-between mb-3">
        <h1 class=" text-dark fs-3">Galeri Video</h1>
    </div>
   
        <div class="card p-3 shadow">
            <div class="table-responsive col-lg-10">
                <a href="/admin/video/add-video" class="btn btn-primary mb-3">Buat Album</a>
                @if (count($video) > 0)
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/admin/video/detail/{{$post->slug}}" class="badge bg-info"><i class="fa-regular fa-eye"></i></a>
                                <a href="/admin/video/edit-video/{{$post->slug}}" class="badge bg-warning"><i
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="/admin/video/delete/{{$post->slug}}" class="btn btn-primary">Iya</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
