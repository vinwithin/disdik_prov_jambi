    ...
    <div id="carouselExampleAutoplaying" class="carousel slide w-75 mx-auto" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="/img/timthumb.jpeg" class="d-block w-100" alt="..."
        ...
        <div class="row ">
            <div class="col-md-8 news-main">
                <div class="card mb-3 mt-5">
                    <img src="/img/timthumb.jpeg" class="card-img-top" alt="Main News">
                    <div class="card-body">
            ...
            <div class="col-md-4 news-sidebar mt-5">
                <div class="card news-card">
                    <img src="/img/timthumb.jpeg" class="card-img-top" alt="News">
                    <div class="card-body">
                        <h5 class="card-title">Mahasiswa Magang</h5>
                        <p class="card-text"><small class="text-muted">9 Juli 2024</small></p>
                        <p class="card-text">At vero eos et accusamus et iusto odio dignissimos ducimus qui
    ...
    <div class="container mt-5 text-dark centered">
        ...
        <div class="row w-100">
            <div class="col-md-8">
                ...
                <div class="announcement">
                    <h5>Program Beasiswa Dumisake Perguruan Tinggi S1 S3 Prov. Jambi</h5>
                    <div class="date-time">
                        <i class="far fa-calendar-alt"></i> 9 Juli 2024 | <i class="far fa-clock ml-2"></i>
                        13:14:14
                    </div>
                ...
                <div class="announcement">
                    <h5>Surat Himbauan Sinergi Digitalisasi Pendidikan Pusdatin Kemendikbudristek RI</h5>
                    <div class="date-time">
                        <i class="far fa-calendar-alt"></i> 9 Juli 2024 | <i class="far fa-clock ml-2"></i>
                        13:14:14
                    </div>
                ...
                <div class="announcement">
                    <h5>Persyaratan Batas Umur Peserta Didik & Lulusan Paket C</h5>
                    <div class="date-time">
                        <i class="far fa-calendar-alt"></i> 9 Juli 2024 | <i class="far fa-clock ml-2"></i>
                        13:14:14
                    </div>
                ...
                <div class="announcement">
                    <h5>Penetapan Juara Lomba pada Kegiatan GEBYAR TIK Tingkat Provinsi Jambi Tahun 2023</h5>
                    <div class="date-time">
                        <i class="far fa-calendar-alt"></i> 9 Juli 2024 | <i class="far fa-clock ml-2"></i>
                        13:14:14
                    </div>
                </div>
                <a href="#" class="btn btn-primary mt-3 mb-5">Lihat Berita Selengkapnya </a>
            </div>
            <div class="col-md-4">
                <div class="preview">
                    <h5>Kesepakatan Rakor BTIKP Tahun 2024</h5>
